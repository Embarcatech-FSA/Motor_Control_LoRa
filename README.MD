## Este é o repositório referente ao receptor. Acesse o repositório do transmissor através deste link: [Transmissor](https://github.com/Embarcatech-FSA/Servo_Control_LoRa_Tx.git).
---
